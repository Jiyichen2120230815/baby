...
public class StringUtil {
    ...
    /**
     * 对数字进行补0操作
     * @param number：数字的字符串形式
     * @param length：最终长度
     * @return String
     */
    public static String fillByZero(String number,int length){
        StringBuilder numberBuilder = new StringBuilder(number);
        for(int i = numberBuilder.length(); i<length; i++){
    ...
    public static String fillByZero(Integer number,int length){
